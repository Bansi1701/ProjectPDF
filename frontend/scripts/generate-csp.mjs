...
const addition = [
  ...
  // Tells browsers to refuse plain HTTP for a year, closing the gap where a
  // first request over HTTP could be intercepted before the redirect lands.
  '  Strict-Transport-Security: max-age=31536000; includeSubDomains',
  '',
].join('\n');

writeFileSync(headersPath, `${existing}${addition}`);
