...
export const GET: APIRoute = async () => {
  ...
  const lines: string[] = [
    ...
    `- Advertising, hosting and analytics: see the [privacy policy](${canonical('/privacy/')}). Document contents and filenames are not advertising data; local processing does not mean the website makes no network requests.`,
