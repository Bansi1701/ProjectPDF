...
faqs:
  ...
  - question: "What should I check after using Redact PDF?"
    answer: "Review every red box before saving. ProjectPDF then verifies that each redacted page contains no extractable text. Keep the original until the new output has been opened and checked."
