---
intro: "Use Compress PDF to choose one PDF, reduce its size and compare the result with the original. The result reports the real byte change instead of promising a percentage before examining the document. ProjectPDF starts the document engine only after you choose a file, performs the work inside this tab, and creates a new result for you to save. Your selected document, its filename, and its contents are not sent to ProjectPDF."
howTo:
  - name: "Choose one PDF"
