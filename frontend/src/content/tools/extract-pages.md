---
intro: "Use Extract PDF pages to choose one PDF, select the pages that should become a separate file. The chosen pages are copied directly, preserving searchable text and original image quality. Filozy starts the document engine only after you choose a file, performs the work inside this tab, and creates a new result for you to save. Your selected document, its filename, and its contents are not sent to Filozy."
howTo:
  - name: "Choose one PDF"
