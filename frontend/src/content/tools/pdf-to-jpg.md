---
intro: "Use PDF to JPG to choose one PDF, render its pages as JPG or PNG images at a chosen resolution. The DPI setting controls output detail, and every page is processed in the browser. Filozy starts the document engine only after you choose a file, performs the work inside this tab, and creates a new result for you to save. Your selected document, its filename, and its contents are not sent to Filozy."
howTo:
  - name: "Choose one PDF"
