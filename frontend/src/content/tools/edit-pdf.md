---
intro: "Use Edit PDF to choose one PDF, place text, signatures, highlights, drawings, and shapes directly on its pages. Every placed object stays movable, resizable, rotatable, and editable until the new PDF is exported. ProjectPDF starts the document engine only after you choose a file, performs the work inside this tab, and creates a new result for you to save. Your selected document, its filename, and its contents are not sent to ProjectPDF."
howTo:
  - name: "Choose one PDF"
