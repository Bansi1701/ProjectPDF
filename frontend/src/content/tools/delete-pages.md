---
intro: "Use Delete PDF pages to choose one PDF, mark unwanted pages and save the remainder. Deleted pages are omitted from the new copy; the file you selected is never overwritten. Filozy starts the document engine only after you choose a file, performs the work inside this tab, and creates a new result for you to save. Your selected document, its filename, and its contents are not sent to Filozy."
howTo:
  - name: "Choose one PDF"
